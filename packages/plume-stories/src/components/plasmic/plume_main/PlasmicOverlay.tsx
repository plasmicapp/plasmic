...
import * as sty from "./PlasmicOverlay.module.css"; // plasmic-import: nAHsu9G3ya/css
...
export const PlasmicOverlay__ArgProps = new Array<ArgPropType>("children");
...
export interface DefaultOverlayProps extends p.BaseTriggeredOverlayProps {
  children?: React.ReactNode;
}
