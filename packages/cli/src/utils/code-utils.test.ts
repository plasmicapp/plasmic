...
`
  ...
  it("renames a skeleton to follow its component", async function () {
    const code = `// This is a skeleton starter React component generated by Plasmic.
...
} from "./plasmic/project_1/PlasmicButton";
import { PlasmicButtonGroup } from "./plasmic/project_1/PlasmicButtonGroup";
...
function Button_(props: ButtonProps, ref: HTMLElementRefOf<"button">) {
  ...
  // designed in Plasmic.
  const overrides: PlasmicButton__OverridesType = {
    root: { onClick: () => analytics.Button.track("click") }
  };
  return (
    <PlasmicButtonGroup>
      <PlasmicButton root={{ ref }} {...props} {...overrides} />
    </PlasmicButtonGroup>
  );
}
...
`;
    const context = {
      config: { preserveJsImportExtensions: false },
      absoluteSrcDir: "/tmp/src",
      cliArgs: {},
    } as any;
    const renamed = await renameSkeletonComponent(context, code, {
      oldName: "Button",
      newName: "PrimaryButton",
      oldSkeletonPath: "Button.tsx",
      newSkeletonPath: "buttons/PrimaryButton.tsx",
      oldRenderModulePath: "plasmic/project_1/PlasmicButton.tsx",
      newRenderModulePath: "plasmic/project_1/PlasmicPrimaryButton.tsx",
    });
    expect(renamed)
      .toEqual(`// This is a skeleton starter React component generated by Plasmic.
// This file is owned by you, feel free to edit as you see fit.
import * as React from "react";
import {
...
} from "../plasmic/project_1/PlasmicPrimaryButton";
import { PlasmicButtonGroup } from "./plasmic/project_1/PlasmicButtonGroup";
import { HTMLElementRefOf } from "@plasmicapp/react-web";
import { analytics } from "../analytics";
...
function PrimaryButton_(
  props: PrimaryButtonProps,
  ref: HTMLElementRefOf<"button">
) {
  // Use PlasmicPrimaryButton to render this component as it was
  // designed in Plasmic.
  const overrides: PlasmicPrimaryButton__OverridesType = {
    root: { onClick: () => analytics.Button.track("click") }
  };
  return (
    <PlasmicButtonGroup>
      <PlasmicPrimaryButton root={{ ref }} {...props} {...overrides} />
    </PlasmicButtonGroup>
  );
}
