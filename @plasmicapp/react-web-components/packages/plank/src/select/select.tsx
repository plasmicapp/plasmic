...
export type PlankSelectProps<T> = Omit<
  AriaSelectProps<T>,
  keyof AsyncLoadable
> &
  StyleProps &
...
export type PlankSelectRef = FocusableRef;
export type PlankSelectRefValue = FocusableRefValue;

interface PlankSelectConfig<R extends Renderer<any, any, any, any>> {
...
export function usePlankSelect<
  T extends object,
  P extends PlankSelectProps<T>,
  R extends Renderer<any, any, any, any>
>(
  plasmicClass: PlasmicClass<R>,
  props: P,
  config: PlankSelectConfig<R>,
  ref: PlankSelectRef = null
) {
  const {
    isDisabled,
    shouldFlip = false,
