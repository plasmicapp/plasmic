...
export type PlankCheckboxRef = FocusableRef<HTMLLabelElement>;

export type PlankCheckboxProps = AriaCheckboxProps & StyleProps & HoverEvents;

interface PlankCheckboxConfig<R extends Renderer<any, any, any, any>> {
...
export function usePlankCheckbox<
  P extends PlankCheckboxProps,
  R extends Renderer<any, any, any, any>
>(
  plasmicClass: PlasmicClass<R>,
  props: P,
  config: PlankCheckboxConfig<R>,
  ref: PlankCheckboxRef = null
) {
