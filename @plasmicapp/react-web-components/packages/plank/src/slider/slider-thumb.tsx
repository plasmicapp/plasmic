...
export type PlankSliderThumbProps = SliderThumbProps & StyleProps;

export type PlankSliderThumbRef = FocusableRef;

export interface PlankSliderThumbConfig<R extends AnyRenderer> {
...
export function usePlankSliderThumb<
  P extends PlankSliderThumbProps,
  R extends AnyRenderer
>(
  plasmicClass: PlasmicClass<R>,
  props: P,
  config: PlankSliderThumbConfig<R>,
  ref: PlankSliderThumbRef = null
) {
