...
export type PlankSwitchRef = FocusableRef<HTMLLabelElement>;

export type PlankSwitchProps = AriaSwitchProps & StyleProps & HoverEvents;

interface PlankSwitchConfig<R extends AnyRenderer> {
...
export function usePlankSwitch<
  P extends PlankSwitchProps,
  R extends AnyRenderer
>(
  plasmicClass: PlasmicClass<R>,
  props: P,
  config: PlankSwitchConfig<R>,
  ref: PlankSwitchRef = null
) {
