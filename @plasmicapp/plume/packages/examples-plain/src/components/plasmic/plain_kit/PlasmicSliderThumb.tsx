    ...
    >
      {(hasVariant(variants, 'isDragging', 'isDragging') ? true : false) ? (
        <div
          ...
          className={classNames({
            'SliderThumb__tooltipContainer--hasLabel__t9EjRGzvrM': hasVariant(
              variants,
              'hasLabel',
              'hasLabel'
            ),

            'SliderThumb__tooltipContainer--isDisabled__t9EjRiTnwH': hasVariant(
              variants,
              'isDisabled',
              'isDisabled'
            ),

            'SliderThumb__tooltipContainer--isDragging__t9EjRUMPBq': hasVariant(
              variants,
              'isDragging',
              'isDragging'
            ),

            SliderThumb__tooltipContainer__t9EjR: true,
            'plasmic-default__all': true,
            'plasmic-default__div': true,
          })}
        >
          <PlasmicSlot defaultContents={'35'} value={args.tooltip} />
        </div>
      ) : null}
...
type PlasmicSliderThumbTooltipContainerProps = PlasmicSliderThumb__VariantsArgs &
  PlasmicSliderThumb__ArgsType & {
    variants?: PlasmicSliderThumb__VariantsArgs;
    args?: PlasmicSliderThumb__ArgsType;
    overrides?: {
...
PlasmicSliderThumb.tooltipContainer = function PlasmicSliderThumbTooltipContainer<
  T extends PlasmicSliderThumbTooltipContainerProps
>(props: T & StrictProps<T, PlasmicSliderThumbTooltipContainerProps>) {
  const { variants, args, overrides } = deriveRenderOpts(props, {
    name: 'tooltipContainer',
    descendantNames: ['tooltipContainer'],
    internalArgPropNames: PlasmicSliderThumb__ArgProps,
    internalVariantPropNames: PlasmicSliderThumb__VariantProps,
  });
