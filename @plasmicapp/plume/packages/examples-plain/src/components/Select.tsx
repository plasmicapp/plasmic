...
import { PlumeSelectProps, PlumeSelectRef, usePlumeSelect } from '@plasmicapp/plume';
...
function Select_<T extends object>(props: SelectProps<T>, ref: PlumeSelectRef) {
  const {plumeProps} = usePlumeSelect<T, SelectProps<T>, ReturnType<typeof PlasmicSelect.createRenderer>>(
    PlasmicSelect,
    props,
    {
