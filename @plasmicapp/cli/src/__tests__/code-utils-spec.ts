import { tsxToJsx, formatScript, replaceImports } from "../utils/code-utils";
...
export const CodeSandboxDialogContent = observer(
    ...
    expect(formatScript(tsxToJsx(code)).trim()).toEqual(
      `
// This is a skeleton starter React component generated by Plasmic.
// @jsx helper
...
`;
    const replaced = replaceImports(
      ...
      {
        scheme: "css",
        defaultStyleCssFilePath: "/tmp/newDir/PP__plasmic__default_style.css"
      },
      {
        "f68b061e-0f85-41c1-8707-3ba9f634f1af": {
          id: "f68b061e-0f85-41c1-8707-3ba9f634f1af",
          name: "PlasmicCodeSandboxDialogContent",
          renderModuleFilePath: "/tmp/newDir/PP__CodeSandboxDialogContent.tsx",
          importSpec: {
            modulePath: "/tmp/newDir/CodeSandboxDialogContent.tsx"
          },
          projectId: "aBwbYpvCqht4V3F8CJNJX3",
          cssFilePath: "/tmp/newDir/PP__CodeSandboxDialogContent.css",
          type: "managed",
          scheme: "direct"
        },
        "4SYnkOQLd5": {
          id: "4SYnkOQLd5",
          name: "Button",
          renderModuleFilePath: "/tmp/newDir/PP__Button.tsx",
          importSpec: {
            modulePath: "/tmp/newDir/Button.tsx"
          },
          projectId: "aBwbYpvCqht4V3F8CJNJX3",
          cssFilePath: "/tmp/newDir/PP__Button.css",
          type: "managed",
          scheme: "direct"
        }
      },
      ...
      {}, // globalVariantConfigMap
      {
        rFn9Vj2p9: {
          id: "rFn9Vj2p9",
          name: "Close",
          moduleFilePath: "/tmp/newDir/PlasmicIcon__Close.tsx"
        }
      } // iconConfigsMap
    );
...
*/
`;
    expect(formatScript(input)).toEqual(
      `import React, { ReactNode } from "react";
import "@plasmicapp/react-web/lib/plasmic.css";
