...
export default function PlasmicLoader({ projectId, component, componentProps = {} }) {
  if (componentsWithOneProject[component]) {
    return React.createElement(componentsWithOneProject[component], componentProps);
  }
  ...
  return React.createElement(componentMap[component][projectId], componentProps);
}`;
