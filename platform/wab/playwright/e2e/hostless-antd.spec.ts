...
test.describe("hostless-antd", () => {
  ...
  test("works", async ({ models }) => {
    await models.studio.createNewFrame().then(async (framed) => {
      ...
      await models.studio.leftPanel.insertNode("AntdInput");
      ...
      await models.studio.rightPanel.selectDataPickerItem("antdInput");

      await models.studio.leftPanel.insertNode("AntdCheckbox");
      await models.studio.leftPanel.insertNode("Text");
