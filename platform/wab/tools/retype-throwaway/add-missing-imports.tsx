...
function main() {
  for (const path of glob.sync("@/wab/**/*.{ts,tsx}")) {
    if (["@/wab/shared/model/classes.ts"].includes(path)) {
      continue;
    }
    ...
    const pattern = [
      "@/wab/__tests__/model-spec.ts",
      "@/wab/shared/model/model-generator.ts",
      "@/wab/shared/bundler.ts",
      "@/wab/shared/model/classes-metas.ts",
      "@/wab/shared/model/model-change-util.ts",
      "@/wab/shared/model/model-util.ts",
      "@/wab/shared/site-diffs/model-conflicts-meta.ts",
    ].includes(path)
      ? // without Type
