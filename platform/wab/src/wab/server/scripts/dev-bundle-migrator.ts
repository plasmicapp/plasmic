...
const paths = [
  ...
  "@/wab/shared/codegen/__tests__/bundles/counters-test.json",
  "@/wab/shared/codegen/__tests__/bundles/todoapp.json",
  "@/wab/shared/codegen/__tests__/bundles/form-with-reset-input.json",
  "@/wab/shared/codegen/__tests__/bundles/people-list-explicit-states.json",
  "@/wab/shared/codegen/__tests__/bundles/hidden-components.json",
  "@/wab/shared/codegen/__tests__/bundles/aria-code-components.json",
  "@/wab/shared/codegen/__tests__/bundles/custom-functions-test.json",
  "@/wab/server/pkg-mgr/data/plume-master-pkg.json",
  "@/wab/server/pkg-mgr/data/plexus-master-pkg.json",
  ...
  "@/wab/shared/site-diffs/_tests_/bundles/code-components-with-same-name.json",
  "@/wab/shared/site-diffs/_tests_/bundles/rich-text-conflict.json",
  "@/wab/shared/site-diffs/_tests_/bundles/test-tpl-merge.json",
  "@/wab/shared/site-diffs/_tests_/bundles/test-tpl-parent-merge.json",
  "@/wab/shared/site-diffs/_tests_/bundles/multiple-interactions-with-conflicts.json",
  "@/wab/shared/site-diffs/_tests_/bundles/arg-variants-conflict-after-swap-components.json",
  "@/wab/shared/site-diffs/_tests_/bundles/test-merging-deps.json",
  "@/wab/shared/site-diffs/_tests_/bundles/test-edge-cases-merge.json",
  "@/wab/shared/site-diffs/_tests_/bundles/test-edge-cases-merge-2.json",
  "@/wab/shared/site-diffs/_tests_/bundles/test-reroot.json",
  "@/wab/shared/site-diffs/_tests_/bundles/global-context-merge.json",
  "@/wab/shared/site-diffs/_tests_/bundles/style-tokens-conflict.json",
  "@/wab/shared/site-diffs/_tests_/bundles/default-slot-change.json",
  "@/wab/shared/insertable-templates/__tests__/bundles/copy-and-paste.json",
  "@/wab/server/__tests__/bundle-migrations/fixtures/style-variants.migrated.json",
  "@/wab/server/__tests__/bundle-migrations/fixtures/code-component-variants.migrated.json",
  "@/wab/server/__tests__/bundle-migrations/fixtures/plume-default-components.migrated.json",
  "@/wab/server/__tests__/bundle-migrations/fixtures/duplicate-variants.migrated.json",
  "@/wab/server/__tests__/bundle-migrations/fixtures/merge-duplicate-variants.migrated.json",
];
