...
const paths = [
  ...
  "src/wab/shared/site-diffs/__tests__/bundles/code-components-with-same-name.json",
  "src/wab/shared/site-diffs/__tests__/bundles/rich-text-conflict.json",
  "src/wab/shared/site-diffs/__tests__/bundles/test-tpl-merge.json",
  "src/wab/shared/site-diffs/__tests__/bundles/test-merging-deps.json",
  "src/wab/shared/site-diffs/__tests__/bundles/test-edge-cases-merge.json",
  "src/wab/shared/site-diffs/__tests__/bundles/test-edge-cases-merge-2.json",
  "src/wab/shared/site-diffs/__tests__/bundles/test-reroot.json",
  "src/wab/shared/site-diffs/__tests__/bundles/global-context-merge.json",
  "src/wab/shared/site-diffs/__tests__/bundles/style-tokens-conflict.json",
  "src/wab/shared/site-diffs/__tests__/bundles/default-slot-change.json",
