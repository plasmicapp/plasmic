...
import {
  DefaultAddCommentMarkerProps,
  PlasmicAddCommentMarker,
  PlasmicAddCommentMarker__OverridesType,
} from "@/wab/client/plasmic/plasmic_kit_comments/PlasmicAddCommentMarker";
...
// Omit to hide them:
//
// interface AddCommentMarkerProps extends Omit<DefaultAddCommentMarkerProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
export function AddCommentMarker(props: AddCommentMarkerProps) {
  ...
  return <PlasmicAddCommentMarker {...props} />;
}
