...
// Omit to hide them:
//
// interface CommentPostFormDialogProps extends Omit<DefaultCommentPostFormDialogProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
// You can also stop extending from DefaultCommentPostFormDialogProps altogether and have
...
export const CommentPostFormDialog = observer(function CommentPostFormDialog(
  ...
  // Use PlasmicCommentPostFormDialog to render this component as it was
  // designed in Plasmic, by activating the appropriate variants,
  // attaching the appropriate event handlers, etc.  You
  // can also install whatever React hooks you need here to manage state or
  // fetch data.
  //
  // Props you can pass into PlasmicCommentPostFormDialog are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all CommentPostFormDialogProps here, but feel free
  ...
  const focusedTpl = commentsCtx.openedThreadTpl();
