      ...
      <MultiAssetsActions
        ...
        onDelete={async (selected: string[]) => {
          ...
          const tokensUsages = tokens
            .map((t) => ({
              usages: extractTokenUsages(studioCtx.site, t),
              token: t,
            }))
            ...
            const confirmed = await reactConfirm({
              message: (
                <>
                  <p>
                    <strong>
                      {tokensUsages.map(({ token }) => token.name).join(", ")}
                    </strong>{" "}
                    are being used in your project.
                  </p>
                  Are you sure you want to delete it? Deleting the token will
                  hard code its value at all its usages.
                </>
              ),
            });
