...
// Omit to hide them:
//
// interface CmsListItemProps extends Omit<DefaultCmsListItemProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function CmsListItem_(props: CmsListItemProps, ref: HTMLElementRefOf<"a">) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicCmsListItem are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all CmsListItemProps here, but feel free
  // to do whatever works for you.

  return <PlasmicCmsListItem root={{ ref }} {...props} />;
}

const CmsListItem = React.forwardRef(CmsListItem_);
