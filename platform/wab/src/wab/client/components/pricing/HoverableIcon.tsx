...
} from "../../plasmic/plasmic_kit_pricing/PlasmicHoverableIcon";
...
// Omit to hide them:
//
// interface HoverableIconProps extends Omit<DefaultHoverableIconProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function HoverableIcon_(
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicHoverableIcon are:
