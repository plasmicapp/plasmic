 ...
 *
 * - `card`: a tile with a large preview image/video, used for items with
 *   previews (section templates, component store, component presets).
 * - `row`: a compact list row with an icon and hover insert actions.
 *
 */
interface AddDrawerItemProps {
  ...
  /** Row only: indentation level, for sub-components. */
  indent?: number;
}
