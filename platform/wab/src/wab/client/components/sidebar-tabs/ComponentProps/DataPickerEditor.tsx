...
import { mkShortId, spawn, uniqueName } from "@/wab/common";
...
export const DataPickerEditor = observer(function DataPickerEditor_(props: {
  ...
  const autoFocusCallback = React.useCallback((divElement: HTMLDivElement) => {
    if (divElement) {
      divElement.focus();
    }
  }, []);
