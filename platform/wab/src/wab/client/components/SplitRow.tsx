...
// Omit to hide them:
//
// interface SplitRowProps extends Omit<DefaultSplitRowProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function SplitRow(props: SplitRowProps) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicSplitRow are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all SplitRowProps here, but feel free
  // to do whatever works for you.
  return <PlasmicSplitRow {...props} />;
}
