...
export type PlasmicDocsPortalIntro__OverridesType = {
  ...
  introText2?: Flex__<"div">;
  introText3?: Flex__<"div">;
  nextConfig?: Flex__<typeof DocsCodeSnippet>;
  gatsbyConfig?: Flex__<typeof DocsCodeSnippet>;
  syncProjectSnippet?: Flex__<typeof SyncProjectSnippet>;
  loaderv2Config?: Flex__<typeof DocsCodeSnippet>;
};
...
function PlasmicDocsPortalIntro__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames("all", sty.freeBox__jHwmp, {
      ...
      >
        ...
        <div
          ...
          className={classNames("all", "__wab_text", sty.introText, {
        ...
        {(
          ...
          <div
            ...
            className={classNames("all", "__wab_text", sty.introText2, {
        ...
        <div
          ...
          className={classNames("all", "__wab_text", sty.introText3, {
        ...
        <div
          className={classNames("all", "__wab_text", sty.text__wBb3B, {
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text__yybgg, {
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text__qu0MA, {
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text__sWP8, {
        ...
        {(
          ...
          <PlasmicLink__
            className={classNames("all", "a", "a__dyzP6", sty.link__qwNoU, {
            ...
            href={
              hasVariant(globalVariants, "codegenType", "loader2")
                ...
                : hasVariant(globalVariants, "codegenType", "loader")
                ? "https://www.plasmic.app/learn/loader-guide/"
                : "https://www.plasmic.app/learn/blackbox-scheme/"
            }
            platform={"react"}
          >
            <div
              className={classNames("all", "__wab_text", sty.text__c0YQa, {
            ...
            <OpenIcon
              className={classNames("all", sty.svg__thLZm, {
        ...
        {(
          ...
          <PlasmicLink__
            className={classNames("all", "a", "a__dyzP6", sty.link__nkI2J, {
          ...
          >
            <div
              className={classNames("all", "__wab_text", sty.text__y5WeE, {
            ...
            <OpenIcon
              className={classNames("all", sty.svg__jEkUg, {
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text___0M2Q4, {
        ...
        {(
          ...
          <div
            className={classNames("all", sty.freeBox__yVeU, {
          ...
          >
            {(
              ...
              <DotBulletIcon
                className={classNames("all", sty.svg__jc9Br, {
            ...
            {(
              ...
              <div
                className={classNames("all", "__wab_text", sty.text__tnYWg, {
                  [sty.textglobal_codegenType_codegen__tnYWgqLpg]: hasVariant(
                    globalVariants,
                    "codegenType",
                    "codegen"
                  ),
                  [sty.textglobal_codegenType_loader2__tnYWgZGeqY]: hasVariant(
                    globalVariants,
                    "codegenType",
                    "loader2"
                  ),
              ...
              >
                <React.Fragment>
                  <span
                    className={
                      "plasmic_default__all plasmic_default__span plasmic_default__span__dyzP6"
                    }
        ...
        {(
          ...
          <div
            className={classNames("all", sty.freeBox___7XNk3, {
          ...
          >
            <DotBulletIcon
              className={classNames("all", sty.svg___46F7S, {
            ...
            {(
              ...
              <div
                className={classNames("all", "__wab_text", sty.text__vA8S1, {
                  [sty.textglobal_codegenType_codegen__vA8S1QLpg]: hasVariant(
                    globalVariants,
                    "codegenType",
                    "codegen"
                  ),
                  [sty.textglobal_codegenType_loader2__vA8S1ZGeqY]: hasVariant(
                    globalVariants,
                    "codegenType",
                    "loader2"
                  ),
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text__xsulm, {
        ...
        <div
          className={classNames("all", "__wab_text", sty.text__f3JUb, {
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text__sw77C, {
        ...
        {(
          ...
          <div
            className={classNames("all", "__wab_text", sty.text__z0N94, {
        ...
        <PlasmicLink__
          className={classNames("all", "a", "a__dyzP6", sty.link__posaU, {
          ...
          href={
            hasVariant(globalVariants, "codegenType", "loader2")
              ? "https://docs.plasmic.app/learn/technical-overview/"
              : hasVariant(globalVariants, "codegenType", "loader")
              ? "https://www.plasmic.app/learn/loader-guide/"
              : "https://www.plasmic.app/learn/blackbox-scheme/"
          }
        ...
        >
          <div
            className={classNames("all", "__wab_text", sty.text___5PdrN, {
          ...
          <OpenIcon
            className={classNames("all", sty.svg__c8O4O, {
        ...
        <div
          className={classNames("all", "__wab_text", sty.text__qxCbh, {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  Omit<PlasmicDocsPortalIntro__VariantsArgs, ReservedPropsType> &
