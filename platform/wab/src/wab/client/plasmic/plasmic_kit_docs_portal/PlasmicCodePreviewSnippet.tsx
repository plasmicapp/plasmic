...
function PlasmicCodePreviewSnippet__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__edkBc)}>
        {renderPlasmicSlot({
          defaultContents: "Component Name",
          value: args.title,
          className: classNames(sty.slotTargetTitle),
        })}
        <div className={classNames("all", sty.freeBox__j4W4B)}>
          {renderPlasmicSlot({
            defaultContents: "",
            value: args.info,
      ...
      <div className={classNames("all", sty.freeBox___5Chei)}>
        <div
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  Omit<PlasmicCodePreviewSnippet__VariantsArgs, ReservedPropsType> &
