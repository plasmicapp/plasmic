    ...
    () => [
      {
        ...
        initFunc: true ? ($props, $state, $ctx) => $props.type : undefined,
      },
...

      {
        ...
        variableType: "variant",
        initFunc: true
          ? ($props, $state, $ctx) => $props.showAdditionalRow
          : undefined,
      },
  ...
  return (
    ...
    >
      <ListItem
        ...
        actions={
          true ? (
            <div className={classNames(projectcss.all, sty.freeBox__t0Gv2)}>
              {(
                triggers.hover_root
                  ? true
                  : hasVariant($state, "pinState", "selected")
        ...
        additional={p.renderPlasmicSlot({
        ...
        icon={
          ...
          >
            {(hasVariant($state, "type", "toggle") ? true : true)
              ? p.renderPlasmicSlot({
