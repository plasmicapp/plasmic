...
import EyeOffsvgIcon from "../q_4_icons/icons/PlasmicIcon__EyeOffsvg"; // plasmic-import: 7OEXtT9yd/icon
  ...
  return (
    ...
    >
      <p.PlasmicIcon
        ...
        className={classNames(projectcss.all, sty.svg__fSc0K, {
          [sty.svgpinState_evaluatedTrue__fSc0KznhMp]: hasVariant(
            $state,
            "pinState",
            "evaluatedTrue"
          ),

          [sty.svgpinState_pinnedFalse__fSc0KPSWf]: hasVariant(
            $state,
            "pinState",
            "pinnedFalse"
          ),

          [sty.svgpinState_pinnedTrue__fSc0KdSe1E]: hasVariant(
            $state,
            "pinState",
            "pinnedTrue"
          ),

          [sty.svgpinState_selected__fSc0KEqRw]: hasVariant(
            $state,
            "pinState",
            "selected"
          ),
...
type NodeComponentProps<T extends NodeNameType> = {
  ...
  Omit<PlasmicVariantPinButton__ArgsType, ReservedPropsType> &
