...
import { _useGlobalVariants } from "./plasmic"; // plasmic-import: 4B48dRthR8uGgyaBYpWthR/projectModule
...
const data = {
  base: `${"plasmic_tokens_4B48dRthR8uGgyaBYpWthR"} ${"plasmic_tokens_tXkSR39sgCDWSitZxC5xFV"} ${"plasmic_tokens_95xp9cYcv7HrNWpFWWhbcv"}`,
  varianted: [],
};
