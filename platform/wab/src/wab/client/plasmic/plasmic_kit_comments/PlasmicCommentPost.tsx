    ...
    () => [
      {
        ...
        initFunc: true ? ($props, $state, $ctx) => $props.thread : undefined,
      },
    ],
  ...
  return (
    true ? (
      ...
      >
        {true ? (
          <p.Stack
            ...
            className={classNames(projectcss.all, sty.freeBox__sfn9I, {
              [sty.freeBoxthread__sfn9IkhQ]: hasVariant(
                $state,
                "thread",
                "thread"
              ),
            ...
            {true ? (
              ...
              >
                ...
                >
                  ...
                  {true ? (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__xBuRf)}
                    >
                      <PlusIcon
        ...
        {(hasVariant($state, "thread", "thread") ? true : true) ? (
          <Button
