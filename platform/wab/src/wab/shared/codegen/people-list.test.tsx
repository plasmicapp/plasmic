...
import _explicitStatesBundle from "@/wab/shared/codegen/__testonly__/bundles/people-list-explicit-states.json";
import _implicitStatesBundle from "@/wab/shared/codegen/__testonly__/bundles/people-list-implicit-states.json";
