...
// PLA-12912: We do not test different versions of React or NextJS here because react-quill is not compatible with React 19.
...
test.describe(`Plasmic Quill (Rich Text Editor)`, async () => {
  ...
  test(`Rich Text Editor state`, async ({ page }) => {
    ...
    await expect(page.locator(`#quill-state`)).toHaveText("<p>Hello World</p>");
